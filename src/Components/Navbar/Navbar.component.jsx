    ...
    return (<>
            <div className="text-white flex items-center justify-between">
                ...
                <div className="flex gap-3">
                    <div>
                        <button className="bg-red-500 text-white px-2 py-2 text-xs rounded">
                            Use App
                        </button>
                    </div>
...
function NavMD()
{
    return (<>
            <div className="w-full flex items-center gap-3 bg-white px-3 py-1 rounded-md">
                        <BiSearch />
                        <input type="search" className="w-full bg-transparent border-none focus:outline-none" placeholder="Search for movies,events,plays,sports & activities" ></input>
            </div>
    </>)
}
